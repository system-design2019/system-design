...
async function getQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/proceed/all')
...
async function getCollectQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/collect/all')
    return response.data
}
...
async function getAttendQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/fill/all')
    return response.data
}
...
async function getPublishQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/publish/all')
    return response.data
}
...
async function collectQues (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].put('questionnaires/'+id+'/collect')
    return response.data
}
...
async function cancelCollectQues (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].delete('questionnaires/'+id+'/collect')
    return response.data
}
...
async function getQuesContent(id){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/content/'+id)
    let data = {
...
async function getDetail (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/questionnaires/'+id)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function getAnsListByQuesId (quesid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/getUsers/'+quesid)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function getAnsByQUId (quesid, userid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/Answer/'+quesid+'/'+userid)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function commitAns (answer) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/questionnaires/commit', answer)
    return response.data
}
...
async function createQues (data) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/questionnaires/publish', data)
    return response.data
}
...
async function closeQues (quesid) {
    // console.log("创建问卷："+JSON.stringify(data))
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/closeQues/'+quesid)
    return response.data
}
/**
 * Create a new questionnaire
...
async function deleteQues (quesid) {
    // console.log("创建问卷："+JSON.stringify(data))
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/deleteQues/'+quesid)
    return response.data
}
...
"use strict";
/* unused harmony export getTopTen */
/* harmony export (immutable) */ __webpack_exports__["a"] = sendMessage;
/* harmony export (immutable) */ __webpack_exports__["b"] = deleteCache;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_service_js__ = __webpack_require__(4);
...
async function getTopTen(){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('')
    return response.data
}

async function sendMessage(data){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/notifications', data)
    return response.data
}

async function deleteCache(){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].delete('/cache')
    return response.data
}
...
"use strict";
const SET_RANKLIST = 'SET_RANKLIST'
/* harmony export (immutable) */ __webpack_exports__["b"] = SET_RANKLIST;

const SET_ADVERTISES = 'SET_ADVERTISES'
/* harmony export (immutable) */ __webpack_exports__["c"] = SET_ADVERTISES;
...
const SET_PER_INFO = 'SET_PER_INFO'
/* harmony export (immutable) */ __webpack_exports__["b"] = SET_PER_INFO;

const SET_PUBLISHING = 'SET_PUBLISHING'
/* harmony export (immutable) */ __webpack_exports__["c"] = SET_PUBLISHING;

const SET_ATTENDING = 'SET_ATTENDING'
/* harmony export (immutable) */ __webpack_exports__["d"] = SET_ATTENDING;

const SET_STARRING = 'SET_STARRING'
/* harmony export (immutable) */ __webpack_exports__["e"] = SET_STARRING;

const SET_DETAIL = 'SET_DETAIL'
/* harmony export (immutable) */ __webpack_exports__["f"] = SET_DETAIL;

const SET_RECEIVE = 'SET_RECEIVE'
/* harmony export (immutable) */ __webpack_exports__["g"] = SET_RECEIVE;

const CHANGE_LOCAL_STATUS = 'CHANGE_LOCAL_STATUS'
/* harmony export (immutable) */ __webpack_exports__["h"] = CHANGE_LOCAL_STATUS;

const DELETE_LOCAL_ALERT = 'DELETE_LOCAL_ALERT'
/* harmony export (immutable) */ __webpack_exports__["j"] = DELETE_LOCAL_ALERT;

const CHANGE_ALL_LOCAL_STATUS = 'CHANGE_ALL_LOCAL_STATUS'
/* harmony export (immutable) */ __webpack_exports__["i"] = CHANGE_ALL_LOCAL_STATUS;

const DELETE_ALL_LOCAL_ALERT = 'DELETE_ALL_LOCAL_ALERT'
/* harmony export (immutable) */ __webpack_exports__["k"] = DELETE_ALL_LOCAL_ALERT;

const UPDATE_ASSET = 'UPDATE_ASSET'
/* harmony export (immutable) */ __webpack_exports__["l"] = UPDATE_ASSET;
...
"use strict";
const SET_QUESLIST = 'SET_QUESLIST'
/* harmony export (immutable) */ __webpack_exports__["b"] = SET_QUESLIST;

const SET_COLLECT_QUESLIST = 'SET_COLLECT_QUESLIST'
/* harmony export (immutable) */ __webpack_exports__["c"] = SET_COLLECT_QUESLIST;

const SET_ATTEND_QUESLIST = 'SET_ATTEND_QUESLIST'
/* harmony export (immutable) */ __webpack_exports__["d"] = SET_ATTEND_QUESLIST;

const SET_PUBLISH_QUESLIST = 'SET_PUBLISH_QUESLIST'
/* harmony export (immutable) */ __webpack_exports__["e"] = SET_PUBLISH_QUESLIST;

const SET_DETAIL = 'SET_DETAIL'
/* harmony export (immutable) */ __webpack_exports__["f"] = SET_DETAIL;

const SET_LOCAL_COLLECTLIST = 'SET_LOCAL_COLLECTLIST'
/* harmony export (immutable) */ __webpack_exports__["g"] = SET_LOCAL_COLLECTLIST;

const DELETE_QUES_BY_INDEX = 'DELETE_QUES_BY_INDEX'
/* harmony export (immutable) */ __webpack_exports__["h"] = DELETE_QUES_BY_INDEX;
...
"use strict";
const SET_ERRANDLIST = 'SET_ERRANDLIST'
/* harmony export (immutable) */ __webpack_exports__["b"] = SET_ERRANDLIST;

const SET_ATTEND_LIST = 'SET_ATTEND_LIST'
/* harmony export (immutable) */ __webpack_exports__["c"] = SET_ATTEND_LIST;

const SET_DETAIL = 'SET_DETAIL'
/* unused harmony export SET_DETAIL */

const DELETE_FAVOR_BY_INDEX = 'DELETE_FAVOR_BY_INDEX'
...
const routers = [{
        ...
        component: (resolve) => __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(90)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
    },
    {
        ...
        component: (resolve) => __webpack_require__.e/* require */(10).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(81)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
    },
    {
        path: '/',
        component: (resolve) => __webpack_require__.e/* require */(3).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(91)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
        children: [{
                path: '/main',
                name: 'main',
            ...
            },
            {
                path: 'home',
                name: 'home',
                component: (resolve) => __webpack_require__.e/* require */(11).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(89)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'questionnaire',
                name: 'questionnaire',
                component: (resolve) => __webpack_require__.e/* require */(8).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(94)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
            },
            {
                path: 'checkList/:type',
                name: 'checkList',
                component: (resolve) => __webpack_require__.e/* require */(15).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(84)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
            },
            {
                path: 'questionnaire/createQuestionnaire', //check the user's receiveBox
                name: 'createQuestionnaire',
                component: (resolve) => __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(87)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
            },
            {
                path: 'questionnaire/filling', //check the user's receiveBox
                name: 'filling',
                component: (resolve) => __webpack_require__.e/* require */(14).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(88)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'favor',
                name: 'favor',
                component: (resolve) => __webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(96)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'favor/createFavor',
                name: 'createFavor',
                component: (resolve) => __webpack_require__.e/* require */(9).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(86)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
            },
            {
                path: 'personal', //personal page
                name: 'personal',
                component: (resolve) => __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(92)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'personal/attend', //personal page
                name: 'attend',
                component: (resolve) => __webpack_require__.e/* require */(6).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(83)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'personal/publish', //personal page
                name: 'publish',
                component: (resolve) => __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(93)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'personal/collect', //personal page
                name: 'collect',
                component: (resolve) => __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(85)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'personal/account', //personal page
                name: 'account',
                component: (resolve) => __webpack_require__.e/* require */(12).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(82)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            },
            {
                path: 'receiveBox', //check the user's receiveBox
                name: 'receiveBox',
                component: (resolve) => __webpack_require__.e/* require */(13).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(95)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
            }
        ]
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_index__ = __webpack_require__(70);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["default"].Store({
    ...
    modules: {
        Ques:__WEBPACK_IMPORTED_MODULE_5__questionnaire_index_js__["default"],
        Favor: __WEBPACK_IMPORTED_MODULE_6__runFavor_index__["default"],
        Home: __WEBPACK_IMPORTED_MODULE_7__home_index__["a" /* default */],
        Personal: __WEBPACK_IMPORTED_MODULE_8__personal_index__["default"]
    }
}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__actions_js__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mutations_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js__ = __webpack_require__(76);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fill_fill_js__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__check_check_js__ = __webpack_require__(74);
...
/* harmony default export */ __webpack_exports__["default"] = (Ques);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__actions_js__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mutations_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__getters_js__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__actions_js__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mutations_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getters_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__getters_js__);
...
/* harmony default export */ __webpack_exports__["default"] = (Favor);
...
async function getErrandList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/errands/proceed/all')
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function createErrand (data) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/errands/publish', data)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function closeErrand (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/closeErra/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function deleteErrand (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/deleteErra/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function attendErrand (eid, uid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/participate/'+eid+'/'+uid)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function confirmErrand (eid, uid) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/confirm/'+eid+'/'+uid)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function getAttendUserList (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/allParticipant/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function getPersonalInfo() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/user') //!!!这里要改动 axios实例名为service
...
async function setPersonalInfo(data) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].put('/user', data)
    return response.data
}
...
async function getPublishing() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/user/publish/all')
    return response.data
}
...
async function getAttending() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/user/fill/all')
    return response.data
}
...
async function getStarring() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('user/collect/all')
    return response.data
}
...
async function getAlerts(id) {
    ...
    // return response.data
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/notifications/all')
    return response.data
}
...
async function changeAlertStatusById(data) {
    let response = __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].put('/notifications', data)
    return response.data
}
...
async function changeAllAlertStatus() {
    let response = __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].put('/notifications/all/' + true)
    return response.data
}
...
async function deleteAlertById(data) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].delete('/notifications', { data: data })
    return response.data
}
...
async function deleteAllAlerts() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].delete('/notifications/all')
    return response.data
}
...
async function getAllDeals() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].get('/user/asset/all')
...
async function rechargeAsset(paymentAbout) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/money', paymentAbout)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_service_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qs__ = __webpack_require__(56);
...
async function login(username, password, mode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/login', data)
...
async function userRegister(username, password, mode) {
    ...
    if (mode === 'phone')
        ...
        data = { "email": username, "password": password }
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/register', data)
    console.log(response.data)
    return response.data
}
...
async function sendIndentify(username, mode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/code', data)
    console.log(response.data)
    return response.data
}
...
async function checkIndentify(username, mode, inputCode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["default"].post('/code/verify', data)
    console.log(response.data)
    return response.data
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__router_router__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__libs_util__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_vue__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_iview_dist_styles_iview_css__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_animate_css__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__store_index_js__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_vue_cookies__ = __webpack_require__(29);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_8_vuex__["default"])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_user__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_system__ = __webpack_require__(20);
...
const SEND_IDENTIFY = 'SEND_IDENTIFY'
/* unused harmony export SEND_IDENTIFY */

const CHECK_IDENTIFY = 'CHECK_IDENTIFY'
/* unused harmony export CHECK_IDENTIFY */

const SEND_IDENTIFY2 = 'SEND_IDENTIFY2'
/* unused harmony export SEND_IDENTIFY2 */

const CHECK_IDENTIFY2 = 'CHECK_IDENTIFY2'
/* unused harmony export CHECK_IDENTIFY2 */

const DELETE_CACHE = 'DELETE_CACHE'
/* unused harmony export DELETE_CACHE */


/* harmony default export */ __webpack_exports__["a"] = ({
    [SIGN_IN]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["a" /* login */](info.username, info.password, info.mode)
        return res

    },
    [SIGN_UP]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["b" /* userRegister */](info.username, info.password, info.mode)
        return res
    },
    [MESSAGE]({ commit, state }, data) {
        ...
        console.log('消息：' + JSON.stringify(send))
        return __WEBPACK_IMPORTED_MODULE_2__api_system__["a" /* sendMessage */](send)
    },
    [SEND_IDENTIFY]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["c" /* sendIndentify */](info.username, info.mode)
        return res
    },
    [CHECK_IDENTIFY]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["d" /* checkIndentify */](info.username, info.mode, info.inputCode)
        return res
    },
    [SEND_IDENTIFY2]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["e" /* sendIndentify2 */](info.username, info.mode)
        return res
    },
    [CHECK_IDENTIFY2]({ commit, state }, info) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_user__["f" /* checkIndentify2 */](info.username, info.mode, info.inputCode)
        return res
    },
    [DELETE_CACHE]({ commit, state }){
        return __WEBPACK_IMPORTED_MODULE_2__api_system__["b" /* deleteCache */]()
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_system_js__ = __webpack_require__(20);
...
const GET_ADVERTISES = 'GET_ADVERTISES'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__actions_js__ = __webpack_require__(68);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutations_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_personal_js__ = __webpack_require__(63);
...
const RECHARGE_ASSET = 'RECHARGE_ASSET'
/* unused harmony export RECHARGE_ASSET */

const WITHDRAW_ASSET = 'WITHDRAW_ASSET'
...
/* harmony default export */ __webpack_exports__["a"] = ({
    [GET_INFO]({ commit }) {
        return __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["a" /* getPersonalInfo */]().then((info) => {
    ...
    [UPDATE_INFO]({ state, commit }) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["b" /* setPersonalInfo */](data).then((info) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["b" /* SET_PER_INFO */], data)
        })
    },
    [GET_PUBLISH]({ commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["c" /* getPublishing */]().then((response) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["c" /* SET_PUBLISHING */], response.data)
        })
    },
    [GET_ATTEND]({ commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["d" /* getAttending */]().then((response) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["d" /* SET_ATTENDING */], response.data)
        })
    },
    [GET_STAR]({ commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["e" /* getStarring */]().then((response) => {
    ...
    [GET_ALERTS]({ commit }, id) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["f" /* getAlerts */]().then((response) => {
    ...
    [CHANGE_STATUS]({ state, commit }, index) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["g" /* changeAlertStatusById */](data).then((response) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["h" /* CHANGE_LOCAL_STATUS */], index)
        })

    },
    [CHANGE_ALL_STATUS]({ state, commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["h" /* changeAllAlertStatus */]().then((response) => {
    ...
    [DELETE_ALERT]({ state, commit }, index) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["i" /* deleteAlertById */](data).then((response) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["j" /* DELETE_LOCAL_ALERT */], index)
        })

    },
    [DELETE_ALL_ALERTS]({ state, commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["j" /* deleteAllAlerts */]().then((response) => {
            commit(__WEBPACK_IMPORTED_MODULE_0__mutations_js__["k" /* DELETE_ALL_LOCAL_ALERT */])
        })
    },
    [RECHARGE_ASSET]({ state, commit }, paymentAbout) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["k" /* rechargeAsset */](paymentAbout);
        console.log(res);
        return res;
    },
    [WITHDRAW_ASSET]({ state, commit }, paymentAbout) {
        let res = __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["l" /* withdrawAsset */](paymentAbout);
        console.log(res);
        return res;
    },
    [GET_ASSET]({ state, commit }) {
        __WEBPACK_IMPORTED_MODULE_1__api_personal_js__["m" /* getAllDeals */]().then((response) => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutations__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_date_js__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_question_js__ = __webpack_require__(8);




const GET_QUESLIST = 'GET_QUESLIST'
/* unused harmony export GET_QUESLIST */

const GET_COLLECT_QUESLIST = 'GET_COLLECT_QUESLIST'
/* unused harmony export GET_COLLECT_QUESLIST */

const GET_ATTEND_QUESLIST = 'GET_ATTEND_QUESLIST'
/* unused harmony export GET_ATTEND_QUESLIST */

const GET_PUBLISH_QUESLIST = 'GET_PUBLISH_QUESLIST'
/* unused harmony export GET_PUBLISH_QUESLIST */

const GET_DETAIL = 'GET_DETAIL'
/* unused harmony export GET_DETAIL */

const CREATE_QUES = 'CREATE_QUES'
/* unused harmony export CREATE_QUES */

const CLOSE_QUES = 'CLOSE_QUES'
/* unused harmony export CLOSE_QUES */

const DELETE_QUES = 'DELETE_QUES'
/* unused harmony export DELETE_QUES */

const CHANGE_COLLECT = 'CHANGE_COLLECT'
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  [GET_QUESLIST] ({commit}) {
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["e" /* getQuesList */]().then((info) => {
        if(info.success)
          commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["b" /* SET_QUESLIST */], info.data)
      }
    ) 
  },
  [GET_COLLECT_QUESLIST] ({commit}) {
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["f" /* getCollectQuesList */]().then((info) => {
        if(info.success){
  ...
  [GET_ATTEND_QUESLIST] ({commit}) {
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["g" /* getAttendQuesList */]().then((info) => {
        if(info.success){
  ...
  [GET_PUBLISH_QUESLIST] ({commit}) {
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["h" /* getPublishQuesList */]().then((info) => {
        if(info.success){
  ...
  [GET_DETAIL] ({commit}, id) {
    // console.log('123456789')
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["i" /* getDetail */](id).then((info)=>{
  ...
  [CREATE_QUES] ({commit}, data) {
    ...
    let format = {
      ...
      console.log(format)
    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["j" /* createQues */](format).then((info)=>{
      
    })
  },
  [CHANGE_COLLECT]({state, commit}, id){
    if(state.collectQuesList.indexOf(id) != -1){
      __WEBPACK_IMPORTED_MODULE_2__api_question_js__["k" /* cancelCollectQues */](id).then((info)=>{
        commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["g" /* SET_LOCAL_COLLECTLIST */], id)
      })
    }
    else{
      __WEBPACK_IMPORTED_MODULE_2__api_question_js__["l" /* collectQues */](id).then((info)=>{
        commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["g" /* SET_LOCAL_COLLECTLIST */], id)
      })
    }
  },
  [CLOSE_QUES]({state,commit}, data){
    return __WEBPACK_IMPORTED_MODULE_2__api_question_js__["m" /* closeQues */](data.id).then((info)=>{
      if(data.source == 'ques'){
  ...
  [DELETE_QUES]({state,commit}, data){
    return __WEBPACK_IMPORTED_MODULE_2__api_question_js__["n" /* deleteQues */](data.id).then((info)=>{
      if(data.source == 'ques'){
        commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["h" /* DELETE_QUES_BY_INDEX */], data.index)
      }
...
const checkQues = {
            ...
            actions:{
                GET_QUES({commit}, id){
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["a" /* getQuesContent */](id).then((response)=>{
                        if(response.success){
                ...
                GET_ANS_LIST({commit}, quesid){
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["b" /* getAnsListByQuesId */](quesid).then((response)=>{
                        if(response.success){
                ...
                GET_ANS({commit}, data){
                    __WEBPACK_IMPORTED_MODULE_2__api_question_js__["c" /* getAnsByQUId */](data.quesid, data.userid).then((response)=>{
                        if(response.success){
...
const fillQues = {
            ...
            actions:{
                ...
                POST_QUES({commit},data){
                    ...
                    let response = __WEBPACK_IMPORTED_MODULE_2__api_question_js__["d" /* commitAns */](com)
                    return response
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutations__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_errands_js__ = __webpack_require__(62);



const GET_ERRANDLIST = 'GET_ERRANDLIST'
/* unused harmony export GET_ERRANDLIST */

const GET_ATTEND_LIST = 'GET_ATTEND_LIST'
/* unused harmony export GET_ATTEND_LIST */

const CREATE_FAVOR = 'CREATE_FAVOR'
/* unused harmony export CREATE_FAVOR */

const ATTEND_ERRAND = 'ATTEND_ERRAND'
/* unused harmony export ATTEND_ERRAND */

const CLOSE_ERRAND = 'CLOSE_ERRAND'
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  [GET_ERRANDLIST] ({commit}) {
    __WEBPACK_IMPORTED_MODULE_1__api_errands_js__["a" /* getErrandList */]().then((info) => {
        if(info.success)
          commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["b" /* SET_ERRANDLIST */], info.data)
      }
    ) 
  },
  [CREATE_FAVOR] ({commit}, data) {
    return __WEBPACK_IMPORTED_MODULE_1__api_errands_js__["b" /* createErrand */](data).then((info) => {
        return info.success
  ...
  [GET_ATTEND_LIST]({commit}, id){
    __WEBPACK_IMPORTED_MODULE_1__api_errands_js__["c" /* getAttendUserList */](id).then((info) => {
      if(info.success)
        commit(__WEBPACK_IMPORTED_MODULE_0__mutations__["c" /* SET_ATTEND_LIST */], info.data)
    }
  )},
  [ATTEND_ERRAND]({commit}, data){
    return __WEBPACK_IMPORTED_MODULE_1__api_errands_js__["d" /* attendErrand */](data.eid, data.uid).then((info) => {
      // console.log('aaa')
      return info.success
    })
  },
