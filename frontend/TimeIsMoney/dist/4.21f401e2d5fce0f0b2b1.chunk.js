...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createQues_SetQues_vue__ = __webpack_require__(211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__createQues_EditQues_vue__ = __webpack_require__(209);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__createQues_Pay_vue__ = __webpack_require__(210);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__createQues_Success_vue__ = __webpack_require__(212);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('Card', [_c('p', [_vm._v("类型：" + _vm._s(_vm.getMode(_vm.questions[_vm.curr].mode)))]), _vm._v(" "), _c('Divider'), _vm._v(" "), _c('p', [_vm._v("标题")]), _c('Input', {
    model: {
  ...
  }), _vm._v(" "), _c('Divider'), _vm._v(" "), (_vm.questions[_vm.curr].mode === 2) ? _c('div', [_vm._l((_vm.questions[_vm.curr].choices), function(op, index) {
    return _c('div', {
      staticStyle: {
        "margin": "15px 0"
      }
  ...
  }, [_c('span', [_vm._v("最多可选：")]), _vm._v(" "), _c('InputNumber', {
    attrs: {
  ...
  })], 1), _vm._v(" "), _c('Divider')], 2) : _vm._e(), _vm._v(" "), _c('div', [_c('span', [_vm._v("修改顺序：")]), _vm._v(" "), _c('InputNumber', {
    attrs: {
  ...
  }, [_vm._v("确定")]), _vm._v(" "), _c('Divider')], 1), _vm._v(" "), _c('div', [_c('span', [_vm._v("必填：")]), _vm._v(" "), _c('i-switch', {
    model: {
  ...
  }), _vm._v(" "), _c('Divider')], 1), _vm._v(" "), _c('div', [_c('Button', {
    on: {
      "click": function($event) {
        _vm.deleteQues()
      }
