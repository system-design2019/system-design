...
async function getQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/proceed/all')
...
async function getCollectQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/collect/all')
    return response.data
}
...
async function getAttendQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/fill/all')
    return response.data
}
...
async function getPublishQuesList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/publish/all')
    return response.data
}
...
async function collectQues (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].put('questionnaires/'+id+'/collect')
    return response.data
}
...
async function cancelCollectQues (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].delete('questionnaires/'+id+'/collect')
    return response.data
}
...
async function getQuesContent(id){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/content/'+id)
    let data = {
...
async function getDetail (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/questionnaires/'+id)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function getAnsListByQuesId (quesid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/getUsers/'+quesid)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function getAnsByQUId (quesid, userid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/Answer/'+quesid+'/'+userid)
    // console.log(JSON.stringify(response))
    return response.data
}
...
async function commitAns (answer) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/questionnaires/commit', answer)
    return response.data
}
...
async function createQues (data) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/questionnaires/publish', data)
    return response.data
}
...
async function closeQues (quesid) {
    // console.log("创建问卷："+JSON.stringify(data))
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/closeQues/'+quesid)
    return response.data
}
/**
 * Create a new questionnaire
...
async function deleteQues (quesid) {
    // console.log("创建问卷："+JSON.stringify(data))
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/deleteQues/'+quesid)
    return response.data
}
...
async function getTopTen(){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('')
    return response.data
}

async function sendMessage(data){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/notifications', data)
    return response.data
}

async function deleteCache(){
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].delete('/cache')
    return response.data
}
...
async function getErrandList () {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/errands/proceed/all')
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function createErrand (data) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/errands/publish', data)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function closeErrand (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/closeErra/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function deleteErrand (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/deleteErra/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function attendErrand (eid, uid) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/participate/'+eid+'/'+uid)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function confirmErrand (eid, uid) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/confirm/'+eid+'/'+uid)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function getAttendUserList (id) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/allParticipant/'+id)
    // console.log(JSON.stringify(response.data))
    return response.data
}
...
async function getPersonalInfo() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/user') //!!!这里要改动 axios实例名为service
...
async function setPersonalInfo(data) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].put('/user', data)
    return response.data
}
...
async function getPublishing() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/user/publish/all')
    return response.data
}
...
async function getAttending() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/user/fill/all')
    return response.data
}
...
async function getStarring() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('user/collect/all')
    return response.data
}
...
async function getAlerts(id) {
    ...
    // return response.data
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/notifications/all')
    return response.data
}
...
async function changeAlertStatusById(data) {
    let response = __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].put('/notifications', data)
    return response.data
}
...
async function changeAllAlertStatus() {
    let response = __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].put('/notifications/all/' + true)
    return response.data
}
...
async function deleteAlertById(data) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].delete('/notifications', { data: data })
    return response.data
}
...
async function deleteAllAlerts() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].delete('/notifications/all')
    return response.data
}
...
async function getAllDeals() {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].get('/user/asset/all')
...
async function rechargeAsset(paymentAbout) {
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/money', paymentAbout)
...
async function login(username, password, mode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/login', data)
...
async function userRegister(username, password, mode) {
    ...
    if (mode === 'phone')
        ...
        data = { "email": username, "password": password }
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/register', data)
    console.log(response.data)
    return response.data
}
...
async function sendIndentify(username, mode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/code', data)
    console.log(response.data)
    return response.data
}
...
async function checkIndentify(username, mode, inputCode) {
    ...
    let response = await __WEBPACK_IMPORTED_MODULE_1__util_service_js__["a" /* default */].post('/code/verify', data)
    console.log(response.data)
    return response.data
}
